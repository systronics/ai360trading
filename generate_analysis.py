...
def fetch_market_data():
    ...
    data_summary = ""
    try:
        # Tickers for Nifty, S&P 500, and Bitcoin
...
async def run():
    ...
    for i, s in enumerate(slides):
        img_path, audio_path = OUT/f"an_{i}.png", OUT/f"an_{i}.mp3"
    ...
    video_id = upload_to_youtube(video_path, vid_title, full_desc, ["Nifty", "Trading"])
    if video_id:
