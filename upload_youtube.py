...
# ─── AUTHENTICATION (YOUR ORIGINAL METHOD) ──────────────────────────────────
def get_service():
    """Authenticates using the YOUTUBE_CREDENTIALS environment variable."""
    try:
        # This reads directly from your GitHub Secret
...
def main():
    ...
    # 2. Metadata Check (The fix for your previous Traceback error)
    if meta_path.exists():
