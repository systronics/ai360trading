...
**2026-05-30 (multi-year autonomy — for "works without Claude"):** Amit ji's subscription ends in ~10 days; goal = run perfect for years, self-healing, ₹0, no developer. Honest verdict given: was robust for months, not years-unattended. Shipped + VERIFIED:
