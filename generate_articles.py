...
PILLARS = [
    {
        ...
        "title_templates": [
            "{trend} — Stock Market Analysis {date}",
            "S&P 500 & NIFTY {direction} | {trend} — {date} Trading Signals",
            "{trend}: What US, India & Brazil Markets Are Doing Today",
            "Stock Market {direction} on {trend} — {date} Intelligence Report",
            "NIFTY {nifty} & S&P 500 {sp500} | {trend} — {date} Analysis",
...
- Practical advice readers can implement today — not generic advice""",
    },
    {
        ...
        "title_templates": [
            "AI Trading Signals {date} — What Algorithms Are Predicting Now",
            "{trend}: How AI Is Changing Stock Market Trading in 2026",
            "Best AI Trading Strategies {date} — US, India & UK Guide",
            "AI Predicts {trend} — Algorithmic Trading Report {date}",
            "{trend} & AI Trading — {date} Technology Markets Report",
            "How AI Algorithms Are Reading {trend} — {date} Analysis",
            "AI Trading Bot Signals: {trend} — {date} Market Intelligence",
            "Fintech & AI: {trend} Impact on Global Markets — {date}",
        ],
